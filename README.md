...
**项目内容**：1.研究“清水行动-空天一体卫河湖健康”项目，集成星载高分辨率遥感（GF-7）与无人机多光谱遥感技术，构建安康                         汉江流域多尺度水质监测体系，覆盖富营养化、泥沙含量、酸性水及重金属污染（Cd/Zn）等核心指标；
                    2.研发空天地协同观测方法：针对干流大流域（宽域反演）设计卫星遥感水质模型，支流小流域（重点评价）开发无人                       机多光谱数据反演算法，实现从宏观富营养化监测到微观酸性水污染源定位（空间分辨率0.5m）的全流程覆盖；
                    3.创新提出光谱-地物响应耦合模型，结合可见光-近红外光谱特征谱峰位置与实地采样数据，量化矿区重金属元素下酸                       性排水迁移规律，建立安康汉江宽领域-小流域受矿业活动影响环境污染热点时空分布图谱；
                    4.无人机批处理航线设计与遥感影像自动解译将样本采集量减少40%，数据处理效率提升35%。

**项目成果**：1.构建安康流域首个多源遥感水质反演模型库，支持宽流域与小流域精准预测，成果应用于陕西省矿山环境治理规划；                    2.识别3处高风险污染源（T2点位Cd含量超标9倍），提出“源头封堵+生态修复”方案，推动区域水质达标率提升；
                    3.发表SCI论文1篇（《Minerals》，IF=2.5），研发技术获中国地质调查局重点项目（DD20230457）采纳）；
                    4.带队获西安建筑科技大学“粉体杯”创新创业大赛一等奖，项目纳入国家自然科学基金（42272342）支持体系。

## 主要功能

### 1. 水体提取
- 基于NDWI（归一化差异水体指数）进行水体提取(经后期实验发现采用监督分类：支持向量机方法能更好的区分城区污染光谱，仅存在少量建筑物阴影难以区分)
- 支持阈值自动调整和形态学处理
- 生成水体二值化掩膜图像
